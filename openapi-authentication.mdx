...
Your agent forwards the user's identity token to your API. This enables user-specific actions like "check my orders" or "cancel my subscription."

**How it works:**

```
1. Your backend signs a JWT for the user (Identity Verification)
